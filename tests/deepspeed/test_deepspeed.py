...
from t# Import the required modules
import os
import inspect
from accelerate.test_utils import test_scripts_folder
...
mod_file = inspect.getfile(test_scripts_folder)
self.test_scripts_folder = os.path.sep.join(mod_file.split(os.path.sep)[:-1] + ["scripts", "external_deps"])rt AutoConfig, AutoModel, AutoModelForCausalLM, get_scheduler
