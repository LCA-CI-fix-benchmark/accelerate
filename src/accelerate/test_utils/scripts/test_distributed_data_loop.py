...
# you may not use this file except in compliance with the Licens    test_can_disable_even_batches()

    accelerator.print("Test joining uneven inputs")
    test_can_join_uneven_inputs()

    accelerator.print("Test overriding even_batches when joining uneven inputs")ou may obtain a copy of the License at
#
