...
# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.        Example:

        ```python
        >>> from accelerate import Accelerator

        >>> accelerator = Accelerator()the License for the specific language governing permissions and
