...
def init_empty_weights(include_buffers: bool = None):
    ...
    `model.to(device)` with it. To load weights inside your empty model, see [`load_checkpoint_and_dispatch`].
    Make sure to overwrite the default device_map param, otherwise dispatch is not called.
    </Tip>
    """
    if include_buffers is None:
        # Add the load_checkpoint_and_dispatch call
        model.load_checkpoint_and_dispatch(**kwargs)
